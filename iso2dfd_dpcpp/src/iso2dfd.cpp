...
void usage(std::string programName) {
  ...
  std::cout << " Usage: ";
  std::cout << programName << " n1 n2 b1 b2 Iterations " << std::endl
            << std::endl;
 ...
 *
 */
void iso_2dfd_iteration_global(nd_item<2> it, float* next, float* prev,
...
int main(int argc, char* argv[]) {
  ...
  std::cout << "Block Sizes: " << WorkGroup_sizeX << " " << WorkGroup_sizeY
            << std::endl;
      ...
      q.submit([&](handler& cgh) {
        ...
        if (k % 2 == 0)
          cgh.parallel_for<class iso_2dfd_kernel>(
              nd_range<2>{global_nd_range, local_nd_range}, [=](nd_item<2> it) {
