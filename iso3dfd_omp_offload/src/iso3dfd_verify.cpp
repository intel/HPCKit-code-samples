 ...
 */
void iso_3dfd_it_verify(float *ptr_next_base, float *ptr_prev_base, float *ptr_vel_base,
 ...
 */
void iso_3dfd_verify(float *ptr_next, float *ptr_prev, float *ptr_vel, float *coeff,
	const int n1, const int n2, const int n3, const int nreps,
	const int n1_Tblock, const int n2_Tblock, const int n3_Tblock) {

	for (int it = 0; it<nreps; it += 1) {

		iso_3dfd_it_verify(ptr_next, ptr_prev, ptr_vel, coeff,
		...
		it++;
		if(it < nreps)
			iso_3dfd_it_verify(ptr_prev, ptr_next, ptr_vel, coeff,
				n1, n2, n3, n1_Tblock, n2_Tblock, n3_Tblock);
...
bool verifyResults(float *next_base, float *prev_base, float *vel_base, float *coeff,
	const int n1, const int n2, const int n3, const int nIterations,
	const int n1_Tblock, const int n2_Tblock, const int n3_Tblock) {
	...
	iso_3dfd_verify(next_base, prev_base, vel_base, coeff, n1, n2, n3, nIterations, n1_Tblock, n2_Tblock, n3_Tblock);
